...
title: Pipi Metadata
related: RFC1, RFC23, RFC25, RFC25, RFC26, RFC27, RFC39
link: https://github.com/abstractfactory/rfc/blob/master/spec/spec24.md
editor: Marcus Ottosson <marcus@abstractfactory.io>
number: 24
modified: 2014-04-20 16:41:00+0100
...
* Name: http://rfc.abstractfactory.io/spec/24
* Editor: Marcus Ottosson <marcus@abstractfactory.io>
* Related: [RFC1](http://rfc.abstractfactory.io/spec/1), [RFC23](http://rfc.abstractfactory.io/spec/23), [RFC25](http://rfc.abstractfactory.io/spec/25), [RFC25](http://rfc.abstractfactory.io/spec/25), [RFC26](http://rfc.abstractfactory.io/spec/26), [RFC27](http://rfc.abstractfactory.io/spec/27), [RFC39](http://rfc.abstractfactory.io/spec/39)
* State: draft
