...
There have been numerous attempts in the past at associating content with metadata; each of which was deemed unsuited to the goals of Pipi. More information about these goals can be found in [RFC25](http://rfc.abstractfactory.io/spec/25) along with a definition of Metadata in [[RFC26](http://rfc.abstractfactory.io/spec/26)](http://rfc.abstractfactory.io/spec/26)

Why exactly were these methods deemed unsuited?

*Note: have a look at [[RFC26](http://rfc.abstractfactory.io/spec/26)](http://rfc.abstractfactory.io/spec/26) for futher definition of how "metadata" is defined in Pipi.
